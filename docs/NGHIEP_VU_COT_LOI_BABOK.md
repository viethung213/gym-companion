...
| **BR-AC-07** | Tập luyện | **Tập ngoài lịch (Ad-hoc Workout)**:<br>Thực hiện trực tiếp thông qua 2 tùy chọn trên ứng dụng:<br>1. **Tự chọn bài tập**: Chọn trực tiếp các bài tập từ danh mục.<br>2. **AI gợi ý giáo án**: Bấm nút "Tạo bài tập", nhập thông tin (nhóm cơ, thời lượng, cường độ) để gọi trực tiếp API `SuggestAdHocSession` (function tư vấn đồng bộ) khởi tạo giáo án JIT. |
