...
| **FR-AC-08** | **Tập thêm bài bổ trợ linh hoạt (Extra Workouts)**: Sau khi hoàn thành buổi tập chính (bao gồm Cool-down), ứng dụng cung cấp tùy chọn "Tập thêm bài bổ trợ". Backend Go tự động loại bỏ bài đã tập, loại bỏ bài compound nặng và trả về 3 nhóm: (a) Accessory/Core, (b) Cardio LISS, (c) Deep Mobility. Độ trễ < 100ms (API Go thuần, không qua AI). | S |
| **FR-AC-09** | **Quyền chủ động điều chỉnh mức độ của Người dùng (User-Initiated Intensity Control)**: Cho phép người dùng chủ động yêu cầu tăng/giảm mức độ nặng nhẹ bất kỳ lúc nào: (a) Nút "Tăng cường độ 🔥" đầu buổi tập để ép tăng tạ/reps ngay lập tức trong trần BR-AC-02 <= 30%, (b) Tự do ghi đè số tạ/rep thực tế khi tập để thiết lập 1RM mới, (c) Yêu cầu AI Coach đổi sang biến thể bài tập khó hơn (Progression Variant) áp dụng từ buổi sau. | M |
