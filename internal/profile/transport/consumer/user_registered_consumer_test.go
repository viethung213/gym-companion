...
import (
	...
	"github.com/viethung213/gym-companion/internal/profile/transport/consumer"
)
...
func TestUserRegisteredConsumer_ProcessMessage(t *testing.T) {
	...
	consumer := consumer.NewUserRegisteredConsumer(nil, userRepo, outboxLogRepo, txManager)
