...
func NewCreateExerciseHandler(repo port.Repository, clock port.Clock, ids port.IDGenerator) *CreateExerciseHandler {
...
func (h *CreateExerciseHandler) Handle(ctx context.Context, cmd CreateExerciseCommand) (*domain.Exercise, error) {
