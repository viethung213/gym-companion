...
func NewSubmitExerciseForApprovalHandler(repo port.Repository, clock port.Clock, ids port.IDGenerator) *SubmitExerciseForApprovalHandler {
...
func (h *SubmitExerciseForApprovalHandler) Handle(ctx context.Context, cmd SubmitExerciseForApprovalCommand) (*domain.Exercise, error) {
