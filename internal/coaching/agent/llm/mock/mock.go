...
func (m *CoachAgent) GenerateRoadmap(_ context.Context, cc *agent.CoachContext, _ *agent.Feedback) (*roadmap.Roadmap, error) {
	if cc == nil {
		return nil, errors.New("nil CoachContext")
	}
...
func (m *CoachAgent) RegeneratePending(_ context.Context, cc *agent.CoachContext, sessionIDs []string, _ *agent.Feedback) ([]*roadmap.SessionPlanInfo, error) {
...
func (m *CoachAgent) SuggestAdHocSession(_ context.Context, cc *agent.CoachContext, hint agent.AdHocHint) (agent.SuggestedSession, error) {
	if cc == nil {
		return agent.SuggestedSession{}, errors.New("nil CoachContext")
	}
