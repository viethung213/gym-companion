...
Effect: Marks the SessionPlan referenced by `plan_id` as ABORTED.
...
Notes:
- Per issue #173, aborted workouts map to ABORTED (distinction between ABORTED for mid-workout cancellation/timeout vs SKIPPED for non-started sessions).
